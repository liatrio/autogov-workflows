...
- `autogov-version` (optional, string, default: 'v1.2.1'): The autogov version to use.
...
- `autogov-version` (optional, string, default: 'v1.2.1'): The autogov version to use for predicate generation.
...
- `autogov-version` (optional, string, default: 'v1.2.1'): The autogov version to use (input name retained for backwards compatibility).
...
- `autogov-version` (optional, string, default: 'v1.2.1'): The autogov release version to download and use.
