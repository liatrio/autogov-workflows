...
RW_FILES=$(find .github/workflows \( -name "rw-attest-*.yaml" -o -name "rw-*-attest-*.yaml" -o -name "rw-attest-*.yml" -o -name "rw-*-attest-*.yml" -o -name "rw-verify*.yaml" -o -name "rw-verify*.yml" \) -type f)
